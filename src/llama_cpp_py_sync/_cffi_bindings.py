...
Generated: 2026-09-04T07:38:44.126005
llama.cpp commit: 4cbe8b070bb040f3b95845408f100fbf5fb746f1
"""
...
enum mtmd_gen_process_type {
    MTMD_GEN_PROCESS_TYPE_GEN_CODE,
...
struct mtmd_gen_audio_info mtmd_gen_audio_get_info(const mtmd_context * ctx);
struct mtmd_gen_inp mtmd_gen_inp_default(const mtmd_context * ctx);
int32_t mtmd_gen_audio_process(mtmd_context * ctx,
...
struct mtmd_helper_bitmap_wrapper mtmd_helper_bitmap_init_from_file(
...
int32_t mtmd_helper_video_read_next(mtmd_helper_video * ctx,
            mtmd_bitmap ** out_bitmap,
            char ** out_text);
bool mtmd_helper_model_can_chat(const struct llama_context * lctx, const struct mtmd_context * mctx);
mtmd_helper_gen_audio * mtmd_helper_gen_audio_init(
                                    struct llama_context * lctx,
...
int32_t mtmd_helper_gen_audio_set_input(
                        mtmd_helper_gen_audio * ctx,
                        const struct mtmd_helper_gen_audio_inp * inp);
int32_t mtmd_helper_gen_audio_step_prompt(
                        mtmd_helper_gen_audio * ctx,
                        int32_t n_batch);
int32_t mtmd_helper_gen_audio_step_gen(
                        mtmd_helper_gen_audio * ctx,
                        llama_token sampled,
                        const float *  h_state_in,
                        const float ** h_state_out,
                        bool * out_stop);
int32_t mtmd_helper_gen_audio_get_output(
                        mtmd_helper_gen_audio * ctx,
...
MTMD_REQUIRED_SYMBOLS = ('mtmd_default_marker', 'mtmd_context_params_default', 'mtmd_init_from_file', 'mtmd_free', 'mtmd_decode_use_non_causal', 'mtmd_decode_use_mrope', 'mtmd_support_vision', 'mtmd_support_audio', 'mtmd_get_audio_sample_rate', 'mtmd_get_marker', 'mtmd_bitmap_init', 'mtmd_bitmap_init_from_audio', 'mtmd_bitmap_get_nx', 'mtmd_bitmap_get_ny', 'mtmd_bitmap_get_data', 'mtmd_bitmap_get_n_bytes', 'mtmd_bitmap_is_audio', 'mtmd_bitmap_free', 'mtmd_bitmap_get_id', 'mtmd_bitmap_set_id', 'mtmd_bitmap_set_mergeable', 'mtmd_bitmap_init_lazy', 'mtmd_input_chunks_init', 'mtmd_input_chunks_size', 'mtmd_input_chunks_get', 'mtmd_input_chunks_free', 'mtmd_input_chunk_get_type', 'mtmd_input_chunk_get_tokens_text', 'mtmd_input_chunk_get_tokens_image', 'mtmd_input_chunk_get_n_tokens', 'mtmd_input_chunk_get_id', 'mtmd_input_chunk_get_n_pos', 'mtmd_input_chunk_copy', 'mtmd_input_chunk_free', 'mtmd_input_chunk_get_placeholder', 'mtmd_input_chunk_save', 'mtmd_input_chunk_load', 'mtmd_image_tokens_get_n_tokens', 'mtmd_image_tokens_get_id', 'mtmd_image_tokens_get_n_pos', 'mtmd_image_tokens_get_nx', 'mtmd_image_tokens_get_ny', 'mtmd_image_tokens_get_decoder_pos', 'mtmd_tokenize', 'mtmd_tokenize_from_parts', 'mtmd_encode', 'mtmd_encode_chunk', 'mtmd_get_output_embd', 'mtmd_batch_init', 'mtmd_batch_free', 'mtmd_batch_add_chunk', 'mtmd_batch_encode', 'mtmd_batch_get_output_embd', 'mtmd_log_set', 'mtmd_get_cap_from_file', 'mtmd_gen_audio_get_info', 'mtmd_gen_inp_default', 'mtmd_gen_audio_process', 'mtmd_test_create_input_chunks', 'mtmd_helper_video_init_params_default', 'mtmd_helper_init_opt_default', 'mtmd_helper_log_set', 'mtmd_helper_support_video', 'mtmd_helper_bitmap_init_from_file', 'mtmd_helper_bitmap_init_from_buf', 'mtmd_helper_get_n_tokens', 'mtmd_helper_get_n_pos', 'mtmd_helper_image_get_decoder_pos', 'mtmd_helper_eval_chunks', 'mtmd_helper_eval_chunk_single', 'mtmd_helper_decode_image_chunk', 'mtmd_helper_video_init', 'mtmd_helper_video_init_from_buf', 'mtmd_helper_video_free', 'mtmd_helper_video_get_info', 'mtmd_helper_video_read_next', 'mtmd_helper_model_can_chat', 'mtmd_helper_gen_audio_init', 'mtmd_helper_gen_audio_free', 'mtmd_helper_gen_audio_reset', 'mtmd_helper_gen_audio_set_input', 'mtmd_helper_gen_audio_step_prompt', 'mtmd_helper_gen_audio_step_gen', 'mtmd_helper_gen_audio_get_output')
